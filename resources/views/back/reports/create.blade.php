    ...
    margin-bottom: 17px;">تقارير انتشار الامراض </div>
                <div class="row mg-b-20">
                    <div class="parsley-input col-md-5 mg-t-20 mg-md-t-0" id="lnWrapper">
                        <x-forms.label id=""><strong class="">حسب المرض</strong></x-forms.label>
                        <select id="area" name="area" class="form-control select2">
                            <option value=""></option>
                            <option value="نوبة ربوية خفيفة">نوبة ربوية خفيفة</option>
                            <option value="شرى حاد&nbsp">شرى حاد&nbsp</option>
                            <option value="التهاب اذن وسطى يسرى حاد">التهاب اذن وسطى يسرى حاد</option>
                            <option value="انتان تنفسي علوي">انتان تنفسي علوي</option>
