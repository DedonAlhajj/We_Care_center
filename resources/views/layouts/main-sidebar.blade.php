<!-- main-sidebar -->
    ...
    font-weight: 400;
">WeCare</span>
				<a style="width: 44px;" href="{{ url('/' . $page='dashboard') }}"><img src="{{URL::asset('assets/img/brand/favicon.png')}}" class="" alt="logo"></a>
				...
				<div class="app-sidebar__user clearfix">
					<div class="dropdown user-pro-body">
						...
						<div class="user-info">
                            ...
                            <span class="mb-0 text-muted">{{\Illuminate\Support\Facades\Auth::user()->doctor->subgrp}}</span>
						</div>
					</div>
				</div>
				<ul class="side-menu">
                    ...
                    <li class="side-item side-item-category">الاختصاصات</li>
                    <li class="slide">
                        <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M19 5H5v14h14V5zM9 17H7v-7h2v7zm4 0h-2V7h2v10zm4 0h-2v-4h2v4z" opacity=".3"/><path d="M3 5v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2H5c-1.1 0-2 .9-2 2zm2 0h14v14H5V5zm2 5h2v7H7zm4-3h2v10h-2zm4 6h2v4h-2z"/></svg><span class="side-menu__label">الاختصاصات</span><i class="angle fe fe-chevron-down"></i></a>
                        <ul class="slide-menu">
                            <li><a class="slide-item" href="{{ url('/' . $page='departments') }}">كافة الاقسام</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="slide">
                        ...
                        <ul class="slide-menu">
                            <li><a class="slide-item" href="{{ url('/' . $page='patients') }}">كافة المرضى</a>
                            <li><a class="slide-item" href="{{ url('/' . $page='patients/create') }}">اضافة مريض</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="slide">
                        ...
                        <ul class="slide-menu">
                            <li><a class="slide-item" href="{{ url('appointments') }}">كافة الحجوزات</a>
                            <li><a class="slide-item" href="{{ url('/' . $page='patients/create') }}">اضافة حجز</a>
                            </li>
                        </ul>
                    </li>
                    @can('all visit for doctor')
                    <li class="side-item side-item-category">عائدات الزيارات</li>
                    <li class="slide">
                        <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M19 5H5v14h14V5zM9 17H7v-7h2v7zm4 0h-2V7h2v10zm4 0h-2v-4h2v4z" opacity=".3"/><path d="M3 5v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2H5c-1.1 0-2 .9-2 2zm2 0h14v14H5V5zm2 5h2v7H7zm4-3h2v10h-2zm4 6h2v4h-2z"/></svg><span class="side-menu__label">الزيارات التابعة لي</span><i class="angle fe fe-chevron-down"></i></a>
                        <ul class="slide-menu">
                            <li><a class="slide-item" href="{{ url('/' . $page='visits') }}">الدخل و الزيارات التابعة لي</a>
                            </li>
                        </ul>
                    </li>
                    @endcan
                    ...
                    <li class="slide">
                        <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M19 5H5v14h14V5zM9 17H7v-7h2v7zm4 0h-2V7h2v10zm4 0h-2v-4h2v4z" opacity=".3"/><path d="M3 5v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2H5c-1.1 0-2 .9-2 2zm2 0h14v14H5V5zm2 5h2v7H7zm4-3h2v10h-2zm4 6h2v4h-2z"/></svg><span class="side-menu__label">التقارير الخاصة بلمركز</span><i class="angle fe fe-chevron-down"></i></a>
                        <ul class="slide-menu">
                            <li><a class="slide-item" href="{{ url('/' . $page='report') }}">انتشار الامراض حسب الاماكن</a>
                            </li>
                            <li><a class="slide-item" href="{{ url('/' . $page='report/create') }}">اكثر الاماكن انتشار لمرض معين</a>
                            </li>
                        </ul>
                    </li>
                        @endcan

                    <li class="side-item side-item-category">الاعلانات</li>
                    <li class="slide">
                        <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M19 5H5v14h14V5zM9 17H7v-7h2v7zm4 0h-2V7h2v10zm4 0h-2v-4h2v4z" opacity=".3"/><path d="M3 5v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2H5c-1.1 0-2 .9-2 2zm2 0h14v14H5V5zm2 5h2v7H7zm4-3h2v10h-2zm4 6h2v4h-2z"/></svg><span class="side-menu__label">الاعلانات الخاصة بلمركز</span><i class="angle fe fe-chevron-down"></i></a>
                        <ul class="slide-menu">
                            <li><a class="slide-item" href="{{ url('/' . $page='ads') }}">جميع الأعلانات</a>
                            </li>
                            <li><a class="slide-item" href="{{ url('/' . $page='ads/1') }}">الأعلانات المعروضة</a>
                            </li>
                            <li><a class="slide-item" href="{{ url('/' . $page='ads/create') }}">اضافة أعلان</a>
                            </li>
                        </ul>
                    </li>

                    <li class="side-item side-item-category">أسئلة المرضى</li>
                    <li class="slide">
                        <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M19 5H5v14h14V5zM9 17H7v-7h2v7zm4 0h-2V7h2v10zm4 0h-2v-4h2v4z" opacity=".3"/><path d="M3 5v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2H5c-1.1 0-2 .9-2 2zm2 0h14v14H5V5zm2 5h2v7H7zm4-3h2v10h-2zm4 6h2v4h-2z"/></svg><span class="side-menu__label">الاسئلة الخاصة بلمرضى</span><i class="angle fe fe-chevron-down"></i></a>
                        <ul class="slide-menu">
                            <li><a class="slide-item" href="{{ url('/' . $page='questions') }}">جميع الأسئلة</a>
                            </li>
                            <li><a class="slide-item" href="{{ url('/' . $page='questions/'.\Illuminate\Support\Facades\Auth::user()->doctor->subgrp) }}">جميع الأسئلة و الأجوبة</a>
                            </li>
                            <li><a class="slide-item" href="{{ url('/' . $page='questions/'.\Illuminate\Support\Facades\Auth::user()->doctor->subgrp.'/answer') }}">الأسئلة التي يجب الاجابة عنا</a>
                            </li>
                            <li><a class="slide-item" href="{{ url('/' . $page='questions/user/'.\Illuminate\Support\Facades\Auth::user()->id) }}">أسئلتي</a>
                            </li>
                            <li><a class="slide-item" href="{{ url('/' . $page='questions/create') }}">اضافة سؤال</a>
                            </li>
                        </ul>
                    </li>

                    <li class="side-item side-item-category">database</li>
                    <li class="slide">
                        <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M19 5H5v14h14V5zM9 17H7v-7h2v7zm4 0h-2V7h2v10zm4 0h-2v-4h2v4z" opacity=".3"/><path d="M3 5v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2H5c-1.1 0-2 .9-2 2zm2 0h14v14H5V5zm2 5h2v7H7zm4-3h2v10h-2zm4 6h2v4h-2z"/></svg><span class="side-menu__label">database</span><i class="angle fe fe-chevron-down"></i></a>
                        <ul class="slide-menu">
                            <li><a class="slide-item" href="{{ url('/' . $page='services') }}">database </a>
                            </li>
                        </ul>
                    </li>
